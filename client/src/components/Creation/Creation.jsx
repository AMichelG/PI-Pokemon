...
import { getTypes, newPokemon, getPokemon, clearFilter } from '../../redux/actions'
...
function Create() {
    ...
    function validate(formState) {
        ...
        if (pokemon.find(el => el.name.toLowerCase() === formState.name.toLowerCase())) {
        ...
        if (formState.image.length > 0 && !formState.image.match(/([^\s\.]+\.[^\s]{2,}|www\.[^\s]+\.[^\s]{2,})/gi)) {
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    <div>
                        ...
                        <input type='text' id='name' name='name' onChange={handleChange} value={formState.name} minlenght='3' maxlenght='15' placeholder='Type a name...' /><br />
                        {errors.name && (<p className='errors'>{errors.name}</p>)}
                        <br />
                        <label htmlFor='hp'>Hitpoints: </label><br />
                        <input type='number' id='hp' name='hp' onChange={handleChange} value={formState.hp} min={1} max={255} /><br />
                        {errors.hp && (<p className='errors'>{errors.hp}</p>)}
                        <br />
                        <label htmlFor='attack'>Attack: </label><br />
                        <input type='number' id='attack' name='attack' onChange={handleChange} value={formState.attack} min={1} max={180} /><br />
                        {errors.attack && (<p className='errors'>{errors.attack}</p>)}
                        <br />
                        <label htmlFor='specialAttack'>Special Attack: </label><br />
                        <input type='number' id='specialAttack' name='specialAttack' onChange={handleChange} value={formState.specialAttack} min={1} max={180} /><br />
                        {errors.specialAttack && (<p className='errors'>{errors.specialAttack}</p>)}
                        <br />
                        <label htmlFor='defense'>Defense: </label><br />
                        <input type='number' id='defense' name='defense' onChange={handleChange} value={formState.defense} min={1} max={230} /><br />
                        {errors.defense && (<p className='errors'>{errors.defense}</p>)}
                        <br />
                        <label htmlFor='specialDefense'>Special Defense: </label><br />
                        <input type='number' id='specialDefense' name='specialDefense' onChange={handleChange} value={formState.specialDefense} min={1} max={230} /><br />
                        {errors.specialDefense && (<p className='errors'>{errors.specialDefense}</p>)}
                        <br />
                        <label htmlFor='speed'>Speed: </label><br />
                        <input type='number' id='speed' name='speed' onChange={handleChange} value={formState.speed} min={1} max={180} /><br />
                        {errors.speed && (<p className='errors'>{errors.speed}</p>)}
                        <br />
                        <label htmlFor='height'>Height: </label><br />
                        <input type='number' id='height' name='height' onChange={handleChange} value={formState.height} min={1} max={200} /><br />
                        {errors.height && (<p className='errors'>{errors.height}</p>)}
                        <br />
                        <label htmlFor='weight'>Weight: </label><br />
                        <input type='number' id='weight' name='weight' onChange={handleChange} value={formState.weight} min={1} max={9999} /><br />
                        {errors.weight && (<p className='errors'>{errors.weight}</p>)}
                        <br />
                        <label htmlFor='image'>Image: </label><br />
                        <input type='text' id='image' name='image' onChange={handleChange} value={formState.image} /><br />
